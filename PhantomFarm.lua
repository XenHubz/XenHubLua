...
output("WHITE|[|GREEN|XenBot|WHITE|] Setting Up...")
...
output("WHITE|[|BLUE|XenBot|WHITE|] Waiting For You To Load In...")
...
if attempts < 100 then
	...
	output("WHITE|[|RED|XenBot|WHITE|] Failed To Spawn In.")
end

output("WHITE|[|GREEN|XenBot|WHITE|] Finished")
